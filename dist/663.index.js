...
const DefaultDispatchEvents = tslib_1.__importStar(__webpack_require__(2061));
class Dispatcher {
    manager;
    events = new Map();
    constructor(manager) {
...
const tslib_1 = __webpack_require__(6735);
/** @module ShardManager */
const Shard_1 = tslib_1.__importDefault(__webpack_require__(8858));
const Dispatcher_1 = tslib_1.__importDefault(__webpack_require__(9969));
